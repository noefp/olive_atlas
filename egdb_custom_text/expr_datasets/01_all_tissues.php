<p>
  RNA-seq of roots, stem, meristem, leaves, flowers, pollen, fruits (epicarp + mesocarp), seeds, embryo, and testa+endosperm,
  combined from several experiments.
</p>
<h4>Experimental Conditions (all in control conditions with 2 replicates unless otherwise noted):</h4>

<ul>
  <li>Roots.</li>
  <li><span style="color:green;">Roots 4 month.</span></li>
  <li>Stem.</li>
  <li>Meristem.</li>
  <li>Leaves.</li>
  ...
  <li><span style="color:blue;">Seed.</span> Mature seed (whole), 1 replicate.</li>
  <!-- <li><span style="color:blue;">Testa+endosperm.</span> Endosperm and seed coat (testa), 3 replicates.</li>
  <li><span style="color:blue;">Embryo.</span> Mature embryo, 3 replicates.</li> -->
</ul>
...
<p>
  ...
  <span style="color:blue;">Seed</span> (in blue) is a control sample</a>.
  <!-- <span style="color:blue;">Seed, Embryo and Testa+endosperm</span> (in blue) are control samples in conditions are in preparation</a>. -->
  <span style="color:orange;">Pollen</span> samples correspond to mature rehydrated pollen.
  The rest of the tissues (in black) come from three healthy 10-year-old olive trees under field conditions. They were published by <a href="https://doi.org/10.3390/genes11050544" target="_blank">Ramírez-Tejero et al., 2020</a>.
</p>
<p>
